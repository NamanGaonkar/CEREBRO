...
var platforms = []platform{
	...
	{name: "Gitea", url: func(h string) string { return "https://gitea.com/" + h }},
	{name: "Sourcehut", url: func(h string) string { return "https://git.sr.ht/~" + h }},
	{name: "Launchpad", url: func(h string) string { return "https://launchpad.net/~" + h }},
	{name: "Open Hub", url: func(h string) string { return "https://openhub.net/accounts/" + h }, check: notFoundAny("Page not found", "404")},
	{name: "Codecademy", url: func(h string) string { return "https://www.codecademy.com/profiles/" + h }},
	{name: "Exercism", url: func(h string) string { return "https://exercism.org/profiles/" + h }},
	{name: "Codewars", url: func(h string) string { return "https://www.codewars.com/users/" + h }},
	{name: "HackerRank", url: func(h string) string { return "https://www.hackerrank.com/" + h }},
	{name: "Kaggle", url: func(h string) string { return "https://www.kaggle.com/" + h }},
	{name: "Glitch", url: func(h string) string { return "https://glitch.com/@" + h }, check: notFoundAny("Page not found", "404")},
	// ---- Social / media ----
	...
	{name: "Bluesky", url: func(h string) string { return "https://bsky.app/profile/" + h }, check: notFoundAny("Profile not found", "Page not found")},
	{name: "Threads", url: func(h string) string { return "https://www.threads.net/@" + h }, check: loginWallCheck("This page doesn't exist", "Page not found")},
	{name: "Mastodon", url: func(h string) string { return "https://mastodon.social/@" + h }, check: notFoundAny("The page you were looking for doesn't exist", "Page not found")},
	{name: "VK", url: func(h string) string { return "https://vk.com/" + h }, check: loginWallCheck("Page not found")},
	{name: "Kick", url: func(h string) string { return "https://kick.com/" + h }, check: notFoundAny("Page not found")},
	{name: "Rumble", url: func(h string) string { return "https://rumble.com/user/" + h }},
	{name: "Odysee", url: func(h string) string { return "https://odysee.com/@" + h }, check: notFoundAny("Page not found", "404")},
	{name: "Dailymotion", url: func(h string) string { return "https://www.dailymotion.com/" + h }},
	{name: "Snapchat", url: func(h string) string { return "https://www.snapchat.com/add/" + h }, check: loginWallCheck("Page not found", "This page isn't available")},
	{name: "DeviantArt", url: func(h string) string { return "https://www.deviantart.com/" + h }, check: notFoundAny("Not Found", "404")},
	{name: "ArtStation", url: func(h string) string { return "https://www.artstation.com/" + h }},
	{name: "itch.io", url: func(h string) string { return "https://itch.io/profile/" + h }, check: notFoundAny("Not found", "404")},
	{name: "Patreon", url: func(h string) string { return "https://www.patreon.com/" + h }, check: notFoundAny("Page not found")},
	{name: "Ko-fi", url: func(h string) string { return "https://ko-fi.com/" + h }, check: notFoundAny("Page not found", "404")},
	{name: "Substack", url: func(h string) string { return "https://substack.com/@" + h }},
	{name: "Product Hunt", url: func(h string) string { return "https://www.producthunt.com/@" + h }},
	{name: "About.me", url: func(h string) string { return "https://about.me/" + h }},
	{name: "Linktree", url: func(h string) string { return "https://linktr.ee/" + h }, check: notFoundAny("This page is not available", "Page not found")},
	{name: "Mixcloud", url: func(h string) string { return "https://www.mixcloud.com/" + h }},
	{name: "Last.fm", url: func(h string) string { return "https://www.last.fm/user/" + h }},
	{name: "Discogs", url: func(h string) string { return "https://www.discogs.com/user/" + h }},
	{name: "MusicBrainz", url: func(h string) string { return "https://musicbrainz.org/user/" + h }},
	{name: "Goodreads", url: func(h string) string { return "https://www.goodreads.com/" + h }, check: loginWallCheck("Page not found")},
	{name: "Wattpad", url: func(h string) string { return "https://www.wattpad.com/user/" + h }},
	{name: "LibraryThing", url: func(h string) string { return "https://www.librarything.com/profile/" + h }},
	{name: "MyAnimeList", url: func(h string) string { return "https://myanimelist.net/profile/" + h }},
	{name: "AniList", url: func(h string) string { return "https://anilist.co/user/" + h }},
	{name: "Anime-Planet", url: func(h string) string { return "https://www.anime-planet.com/users/" + h }},
	{name: "Letterboxd", url: func(h string) string { return "https://letterboxd.com/" + h }},
	{name: "Chess.com", url: func(h string) string { return "https://www.chess.com/member/" + h }, check: notFoundAny("This page does not exist", "Page not found")},
	{name: "Lichess", url: func(h string) string { return "https://lichess.org/@/" + h }},
	{name: "Internet Archive", url: func(h string) string { return "https://archive.org/details/@" + h }, check: notFoundAny("Not Found", "cannot find")},
	{name: "OpenStreetMap", url: func(h string) string { return "https://www.openstreetmap.org/user/" + h }},
	{name: "Scratch", url: func(h string) string { return "https://scratch.mit.edu/users/" + h }},
	{name: "WordPress", url: func(h string) string { return "https://" + h + ".wordpress.com" }},
	{name: "Blogger", url: func(h string) string { return "https://" + h + ".blogspot.com" }},
	{name: "Speaker Deck", url: func(h string) string { return "https://speakerdeck.com/" + h }},
	{name: "SlideShare", url: func(h string) string { return "https://www.slideshare.net/" + h }},
	{name: "HackerOne", url: func(h string) string { return "https://hackerone.com/" + h }},
	{name: "Bugcrowd", url: func(h string) string { return "https://bugcrowd.com/" + h }},
	{name: "TryHackMe", url: func(h string) string { return "https://tryhackme.com/p/" + h }},
	{name: "Strava", url: func(h string) string { return "https://www.strava.com/athletes/" + h }},
